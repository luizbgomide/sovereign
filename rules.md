...
When multiple Delvers attempt to face a situation together, the choose one to make the roll. For each other Delver with at least level 1 in the skill, add 1 to the roll. For each delver with -1 in the skill, subtract 1.
